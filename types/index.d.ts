...
export interface ClassNames {
  ...
  listDropdown?: string;
  /** @default 'choices__list--scroller' */
  listScroller?: string;
...
export interface Options {
   ...
   * @default 'auto'
   */
  position?: Types.dropdownPosition;
   ...
   * @default 'auto';
   */
  renderSelectedChoices?: Types.renderSelected;
   ...
   * @default null
   */
  callbackOnCreateTemplates?: Types.callbackOnCreateTemplates;
}
...
export default class Choices {
  ...
  constructor(element: string | HTMLElement | HTMLCollectionOf<Element> | NodeList, userConfig?: Options);
  new(element?: string | HTMLElement | HTMLCollectionOf<Element> | NodeList, userConfig?: Options): this;
